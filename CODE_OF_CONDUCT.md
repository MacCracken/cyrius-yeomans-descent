...
Instances of abusive, harassing, or otherwise unacceptable behavior may be reported to the project maintainers via the contact listed in [`SECURITY.md`](SECURITY.md). All complaints will be reviewed and investigated promptly and fairly.
